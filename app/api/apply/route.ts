...
export async function POST(req: Request) {
  ...
  const parsed = applicationSchema.safeParse({
    ...
    experienceLevel: str(form.get("experienceLevel")),
    expectedSalary: str(form.get("expectedSalary")),
    availableStartDate: str(form.get("availableStartDate")),
  ...
  try {
    await sendNotification({
      ...
      text: [
        ...
        data.availableStartDate && `Available Start Date: ${data.availableStartDate}`,
